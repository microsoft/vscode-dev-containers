...
| Metadata | Value |  
|----------|-------|
| *Contributors* | The VS Code Team, grufffta |
...
| *Container OS* | Ubuntu |
| *Languages, platforms* | C#, PowerShell, ZSH, Docker, Go, NodeJS, TypeScript, Helm/Kubectl |
...
Beyond `git`, this image / `Dockerfile` includes `zsh`, [Oh My Zsh!](https://ohmyz.sh/), a non-root `vscode` user with `sudo` access, powershell and a set of common dependencies for development.
...
2. To use the pre-built image:
   ...
   3. Select the 'dotnet-5' definition.

3. To use the Dockerfile for this definition (*rather than the pre-built image*):
   1. Clone this repository.
   2. Copy the contents of `containers/dotnet-5/.devcontainer` to the root of your project folder.
...
4. Select the `containers/dotnet-5` folder.
