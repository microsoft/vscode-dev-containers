...
2. To use VS Code's copy of this definition:
   ...
   3. Select the Node.js (latest LTS) & TypeScript definition.

3. To use latest-and-greatest copy of this definition from the repository:
   1. Clone this repository.
   2. Copy the contents of `containers/typescript-node-lts/.devcontainer` to the root of your project folder.
