...
2. To use VS Code's copy of this definition:
   ...
   3. Select the Swift 4 definition.

3. To use latest-and-greatest copy of this definition from the repository:
   1. Clone this repository.
   2. Copy the contents of `containers/swift-4/.devcontainer` to the root of your project folder.
...
4. Select the `containers/swift-4` folder.
