...
# Install docfx
curl -sSL https://github.com/dotnet/docfx/releases/download/3.0.0-beta1.1201%2Be8ac6197b1/docfx-linux-x64-3.0.0-beta1.1201+e8ac6197b1.zip -o /tmp/docfx.zip
mkdir -p /opt/docfx
