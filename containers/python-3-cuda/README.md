...
| *Published image* | mcr.microsoft.com/vscode/devcontainers/python-cuda |
| *Available image variants* | 3 / 3-focal, 3.6 / 3.6-focal, 3.7 / 3.7-focal, 3.8 / 3.8-focal, 3.9 / 3.9-focal, 3.10 / 3.10-focal, 3-bionic, 3.6-bionic, 3.7-bionic, 3.8-bionic, 3.9-bionic, 3.10-bionic ([full list](https://mcr.microsoft.com/v2/vscode/devcontainers/python-cuda/tags/list)) |
| *Published image architecture(s)* | x86-64, arm64/aarch64 for `focal` variants |
...
```json
// Or you can use 3.8-focal or 3.8-bionic if you want to pin to an OS version
"args": { "VARIANT": "3.8" }
```
...
- `mcr.microsoft.com/vscode/devcontainers/python:3.6` (or `3.6-focal`, `3.6-bionic` to pin to an OS version)
- `mcr.microsoft.com/vscode/devcontainers/python:3.7` (or `3.7-focal`, `3.7-bionic` to pin to an OS version)
- `mcr.microsoft.com/vscode/devcontainers/python:3.8` (or `3.8-focal`, `3.8-bionic` to pin to an OS version)
- `mcr.microsoft.com/vscode/devcontainers/python:3.9` (or `3.9-focal`, `3.9-bionic` to pin to an OS version)
- `mcr.microsoft.com/vscode/devcontainers/python:3.10` (or `3.10-focal`, `3.10-bionic` to pin to an OS version)

You can decide how often you want updates by referencing a [semantic version](https://semver.org/) of each image. For example:

- `mcr.microsoft.com/vscode/devcontainers/python:0-3.9` (or `0-3.9-focal`, `0-3.9-bionic`)
- `mcr.microsoft.com/vscode/devcontainers/python:0.202-3.9` (or `0.202-3.9-focal`, `0.202-3.9-bionic`)
- `mcr.microsoft.com/vscode/devcontainers/python:0.202.0-3.9` (or `0.202.0-3.9-focal`, `0.202.0-3.9-bionic`)
...
See [history](history) for information on the contents of each version and [here for a complete list of available tags](https://mcr.microsoft.com/v2/vscode/devcontainers/python-cuda/tags/list).
