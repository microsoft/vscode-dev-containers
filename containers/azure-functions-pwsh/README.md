...
*Develop Azure Functions in PowerShell. Includes .NET Core 3.1, PowerShell 7, the Azure Functions SDK, and related extensions and dependencies.*
...
3. To use latest-and-greatest copy of this definition from the repository:
   ...
   2. Copy the contents of `containers/azure-functions-pwsh-7/.devcontainer` to the root of your project folder.
...
4. Select the `containers/azure-functions-pwsh-7` folder.
