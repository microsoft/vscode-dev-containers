...
*Develop Node.js 12 based applications. Includes Node.js, eslint, and yarn.*
...
- `mcr.microsoft.com/vscode/devcontainers/javascript-node:0.123-12`
- `mcr.microsoft.com/vscode/devcontainers/javascript-node:0.123.0-12`
...
2. To use the pre-built image:
   ...
   3. Select the Node.js 12 definition.

3. To use the Dockerfile for this definition (*rather than the pre-built image*):
   1. Clone this repository.
   2. Copy the contents of `containers/javascript-node-12/.devcontainer` to the root of your project folder.
...
4. Select the `containers/javascript-node-12` folder.
