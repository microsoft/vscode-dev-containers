...
*Develop Node.js 10 based applications in TypeScript. Includes Node.js, eslint, yarn, and the TypeScript compiler.*
...
- `mcr.microsoft.com/vscode/devcontainers/typescript-node:0.123-10`
- `mcr.microsoft.com/vscode/devcontainers/typescript-node:0.123.0-10`

Alternatively, you can use the contents of the `Dockerfile` or the [JavaScript and Node.js `Dockerfile`](../javascript-node-10/.devcontainer/Dockerfile) to fully customize your container's contents.
...
While `eslint`and `typescript` are installed globally for convenance, [as of ESLint 6](https://eslint.org/docs/user-guide/migrating-to-6.0.0#-plugins-and-shareable-configs-are-no-longer-affected-by-eslints-location), you will need to install the following packages locally to lint TypeScript code: `@typescript-eslint/eslint-plugin`, `@typescript-eslint/parser`, `eslint`, `typescript`.
...
2. To use the pre-built image:
   ...
   3. Select the Node.js 10 & TypeScript definition.

3. To use the Dockerfile for this definition (*rather than the pre-built image*):
   1. Clone this repository.
   2. Copy the contents of `containers/typescript-node-10/.devcontainer` to the root of your project folder.
...
4. Select the `containers/typescript-node-10` folder.
